...
//		tool.addAction(deleteVarArgsAction);
	 ...
	 * method will use the given value of <code>convertPointers</code> to determine if the new
	 * DataType should be made into a pointer if the existing DataType is a pointer.
	 * @param dataType The DataType to create.
	 * @param context The listing context to provide the location at which to create the DataType.
