...
public class InformationBlock {
     ...
     * @return a string represention of the target operating system
     */
    public String getTargetOpSysAsString() {
        switch (ne_exetyp) {
            case EXETYPE_UNKNOWN: return "Unknown";
            case EXETYPE_OS2: return "OS/2";
            case EXETYPE_WINDOWS: return "Windows";
            //case EXETYPE_EUROPEAN_DOS_4: return "European DOS 4.x";
            case EXETYPE_RESERVED4: return "Reserved 4";
            case EXETYPE_WINDOWS_386: return "Windows 386";
            case EXETYPE_BOSS: return "Borland Operating System Services";
            case EXETYPE_PHARLAP_286_OS2: return "Pharlap 286 OS/2";
            case EXETYPE_PHARLAP_286_WIN: return "Pharlap 286 Windows";
        }
        return null;
    }
    /**
     * Returns a string represention of the application flags.
     * @return a string represention of the application flags
     */
     ...
     * @return a string represention of the program flags
     */
