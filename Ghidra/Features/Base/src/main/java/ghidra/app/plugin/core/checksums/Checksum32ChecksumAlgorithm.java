 ...
 */
public class Checksum32ChecksumAlgorithm extends BasicChecksumAlgorithm {

	/**
	 * Constructor for the basic 32-bit checksum algorithm.
	 */
	public Checksum32ChecksumAlgorithm() {
		super(BasicChecksumAlgorithm.SupportedByteSize.CHECKSUM32);
	}
}
