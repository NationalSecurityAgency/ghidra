...
public class TableServiceTableChooserDialog extends TableChooserDialog {

	private final TableServicePlugin plugin;

	public TableServiceTableChooserDialog(TableServicePlugin plugin, TableChooserExecutor executor,
			Program program, String title, Navigatable navigatable, boolean isModal) {
		super(plugin.getTool(), executor, program, title, navigatable, isModal);
		this.plugin = plugin;
	}

	public TableServiceTableChooserDialog(TableServicePlugin plugin, TableChooserExecutor executor,
			Program program, String title, Navigatable navigatable) {
		this(plugin, executor, program, title, navigatable, false);
	}
