...
public class DoubleSearchFormatTest extends AbstractSearchFormatTest {
	...
	public void testSimpleCaseBigEndian() {
		...
		assertBytes(63, -13, 51, 51, 51, 51, 51, 51, 63, -13, 51, 51, 51, 51, 51, 51);
	...
	public void testSimpleCaseLittleEndian() {
		...
		matcher = parse("1.2 1.2");
		assertBytes(51, 51, 51, 51, 51, 51, -13, 63, 51, 51, 51, 51, 51, 51, -13, 63);
		assertMask(0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
			0xff, 0xff, 0xff);
	}
	...
	public void testECase() {
		...
		assertBytes(66, 6, 90, 11, -64, 0, 0, 0);
	}

	@Test
	public void testNegativeECase() {
		matcher = parse("1.2e-10");
		assertBytes(61, -32, 126, 31, -23, 27, 11, 112);
	}
	...
	public void testConvertTextFromFloats() {
		assertEquals("1.234", convertText(floatSettings, "1.234"));
	}
