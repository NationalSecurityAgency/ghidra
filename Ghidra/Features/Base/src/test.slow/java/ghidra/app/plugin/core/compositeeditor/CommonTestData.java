	...
	public static void initialize() {
		try {
			...
			arrayDt = new ArrayDataType(
				new Pointer32DataType(new Pointer32DataType(simpleStructureTypedef)), 3, 4);
		...
		TypeDef tempSimpleStructureTypedef =
			new TypedefDataType("simpleStructureTypedef", simpleStructure);
		complexStructure.add(tempSimpleStructureTypedef); // typedef of a variable data type.
		DataType tempArrayDt = new ArrayDataType(
			new Pointer32DataType(new Pointer32DataType(tempSimpleStructureTypedef)), 3, 4);
