 ...
 */
public class OatDexFile_Android11 extends OatDexFile_Pie {

	public OatDexFile_Android11(BinaryReader reader, VdexHeader vdexHeader) throws IOException {
	...
	public DataType toDataType() throws DuplicateNameException, IOException {
		...
		try {
			String className = StructConverterUtil.parseName(OatDexFile_Android11.class);
