...
%token OP_TRUNC OP_CPOOLREF OP_NEW OP_POPCOUNT OP_LZCOUNT OP_BITREV OP_TZCOUNT
...
expr: varnode { $$ = new ExprTree($1); }
  ...
  | OP_BITREV '(' expr ')' { $$ = slgh->pcode.createOp(CPUI_BITREV,$3); }
  | OP_TZCOUNT '(' expr ')' { $$ = slgh->pcode.createOp(CPUI_TZCOUNT,$3); }
