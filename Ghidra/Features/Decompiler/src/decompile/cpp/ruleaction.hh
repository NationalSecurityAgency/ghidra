...
public:
  RuleCollectTerms(const string &g) : Rule(g, has_canapply, "collect_terms") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleAndMask(const string &g) : Rule(g, has_canapply, "andmask") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleAndOrLump(const string &g) : Rule(g, has_canapply, "andorlump") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleShiftBitops(const string &g) : Rule(g, has_canapply, "shiftbitops") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleEquality(const string &g) : Rule(g, has_canapply, "equality") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RulePullsubMulti(const string &g) : Rule(g, has_canapply, "pullsub_multi") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RulePullsubIndirect(const string &g) : Rule(g, has_canapply, "pullsub_indirect") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RulePushMulti(const string &g) : Rule(g, has_canapply, "push_multi") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleHighOrderAnd(const string &g) : Rule(g, has_canapply, "highorderand") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleAndDistribute(const string &g) : Rule(g, has_canapply, "anddistribute") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleRangeMeld(const string &g) : Rule(g, has_canapply, "rangemeld") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleFloatRange(const string &g) : Rule(g, has_canapply, "floatrange") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleAndCommute(const string &g) : Rule(g, has_canapply, "andcommute") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleAndPiece(const string &g) : Rule(g, has_canapply, "andpiece") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleAndZext(const string &g) : Rule(g, has_canapply, "andzext") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleAndCompare(const string &g) : Rule(g, has_canapply, "andcompare") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleShiftCompare(const string &g) : Rule(g, has_canapply, "shiftcompare") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleTrivialArith(const string &g) : Rule(g, has_canapply, "trivialarith") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleZextEliminate(const string &g) : Rule(g, has_canapply, "zexteliminate") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleSlessToLess(const string &g) : Rule(g, has_canapply, "slesstoless") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleZextSless(const string &g) : Rule(g, has_canapply, "zextsless") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleBitUndistribute(const string &g) : Rule(g, has_canapply, "bitundistribute") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleBooleanUndistribute(const string &g) : Rule(g, has_canapply, "booleanundistribute") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleBooleanNegate(const string &g) : Rule(g, has_canapply, "booleannegate") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleTrivialShift(const string &g) : Rule(g, has_canapply, "trivialshift") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleSignShift(const string &g) : Rule(g, has_canapply, "signshift") {}		///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleTestSign(const string &g) : Rule(g, has_canapply, "testsign") {}		///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleShift2Mult(const string &g) : Rule(g, has_canapply, "shift2mult") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleShiftPiece(const string &g) : Rule(g, has_canapply, "shiftpiece") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleCarryElim(const string &g) : Rule(g, has_canapply, "carryelim") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleSubExtComm(const string &g) : Rule(g,has_canapply,"subextcomm") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleShiftAnd(const string &g) : Rule(g, has_canapply, "shiftand") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleConcatZero(const string &g) : Rule(g, has_canapply, "concatzero") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleConcatLeftShift(const string &g) : Rule(g, has_canapply, "concatleftshift") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleSubZext(const string &g) : Rule(g, has_canapply, "subzext") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleSubCancel(const string &g) : Rule(g, has_canapply, "subcancel") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleShiftSub(const string &g) : Rule(g, has_canapply, "shiftsub") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleBoolNegate(const string &g) : Rule(g, has_canapply, "boolnegate") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleSLess2Zero(const string &g) : Rule(g, has_canapply, "sless2zero") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleEqual2Zero(const string &g) : Rule(g, has_canapply, "equal2zero") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleEqual2Constant(const string &g) : Rule(g, has_canapply, "equal2constant") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  Rule2Comp2Sub(const string &g) : Rule( g, has_canapply, "2comp2sub") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleSubNormal(const string &g) : Rule( g, has_canapply, "subnormal") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleDivOpt(const string &g) : Rule( g, has_canapply, "divopt") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleSignDiv2(const string &g) : Rule( g, has_canapply, "signdiv2") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleDivChain(const string &g) : Rule( g, has_canapply, "divchain") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleSignForm(const string &g) : Rule( g, has_canapply, "signform") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleSignForm2(const string &g) : Rule( g, has_canapply, "signform2") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleSignNearMult(const string &g) : Rule( g, has_canapply, "signnearmult") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleSignMod2nOpt2(const string &g) : Rule( g, has_canapply, "signmod2nopt2") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleIgnoreNan(const string &g) : Rule( g, has_canapply, "ignorenan") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleInt2FloatCollapse(const string &g) : Rule( g, has_canapply, "int2floatcollapse") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  ...
  virtual int4 applyOp(PcodeOp *op,Funcdata &data);
  virtual int4 canApply(const PcodeOp *op,const Funcdata &data) const;
  virtual uint4 getMutationScope(void) const { return scope_op_inputs_defs; }
};
...
public:
  RulePopcountBoolXor(const string &g) : Rule( g, has_canapply, "popcountboolxor") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleXorSwap(const string &g) : Rule(g,has_canapply,"xorswap") {}		///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleFloatSign(const string &g) : Rule( g, has_canapply, "floatsign") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleFloatSignCleanup(const string &g) : Rule( g, has_canapply, "floatsigncleanup") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
...
public:
  RuleOrCompare(const string &g) : Rule( g, has_canapply, "orcompare") {}	///< Constructor
  virtual Rule *clone(const ActionGroupList &grouplist) const {
    if (!grouplist.contains(getGroup())) return (Rule *)0;
