...
public abstract class AbstractSiClassTypeInfoModel extends AbstractClassTypeInfoModel {
	...
	/**
	 * Constructs a new AbstractSiClassTypeInfoModel.
	 * 
	 * @param program the program containing the AbstractSiClassTypeInfoModel.
	 * @param address the address of the AbstractSiClassTypeInfoModel.
	 */
