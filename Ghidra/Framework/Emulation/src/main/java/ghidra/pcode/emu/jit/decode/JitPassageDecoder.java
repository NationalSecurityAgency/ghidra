...
public class JitPassageDecoder {
	 ...
	 */
	@Internal
	public PseudoInstruction decodeInstruction(Address address, RegisterValue ctx) {
		try {
			PseudoInstruction instruction = decoder.decodeInstruction(address, ctx);
			return instruction;
		}
