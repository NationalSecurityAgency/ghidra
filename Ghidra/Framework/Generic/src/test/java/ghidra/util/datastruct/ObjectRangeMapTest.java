...
@Test
    ...
    assertNull(map.getObject(0));
    assertNull(map.getObject(9));
		assertEquals(obj, map.getObject(10));
		assertEquals(obj, map.getObject(20));
    assertNull(map.getObject(21));
...
@Test
    ...
    assertNull(map.getObject(10));
    assertNull(map.getObject(29));
		assertEquals(obj1, map.getObject(30));
		assertEquals(obj1, map.getObject(50));
    assertNull(map.getObject(51));
	}
@Test
    ...
    assertNull(map.getObject(41));
    assertNull(map.getObject(50));
	}
@Test
    ...
    assertNull(map.getObject(30));
    assertNull(map.getObject(40));
...
@Test
    ...
    assertNull(map.getObject(19));
		assertEquals(obj1, map.getObject(20));
		assertEquals(obj1, map.getObject(24));
    assertNull(map.getObject(25));
    assertNull(map.getObject(40));
    assertNull(map.getObject(50));
    assertNull(map.getObject(51));
    assertNull(map.getObject(85));
		assertEquals(obj1, map.getObject(86));
		assertEquals(obj1, map.getObject(90));
    assertNull(map.getObject(91));
	}
