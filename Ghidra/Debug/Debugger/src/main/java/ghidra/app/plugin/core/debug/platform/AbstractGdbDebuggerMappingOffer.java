...
public class AbstractGdbDebuggerMappingOffer extends AbstractDebuggerMappingOffer {
	public AbstractGdbDebuggerMappingOffer(TargetObject target, int confidence,
