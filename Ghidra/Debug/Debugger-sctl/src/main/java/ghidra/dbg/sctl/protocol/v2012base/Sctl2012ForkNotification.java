...
/**
 * Format for the {@code Efork} SCTL event
 */
public class Sctl2012ForkNotification extends AbstractSctlForkNotification {
	public Sctl2012ForkNotification() {
		super();
	}

	public Sctl2012ForkNotification(long spwnid, AbstractSctlContext ctx,
