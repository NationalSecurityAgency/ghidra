...
/**
 * Format for the {@code Tsettrap} SCTL message
 */
public class SctlSetTrapRequest extends AbstractSctlRequest {
	public SctlSetTrapRequest() {
	}

	public SctlSetTrapRequest(long ctlid, AbstractSctlTrapSpec spec) {
		this.ctlid = ctlid;
		this.spec = spec;
	}
	...
	@PacketField
	public AbstractSctlTrapSpec spec;
}
