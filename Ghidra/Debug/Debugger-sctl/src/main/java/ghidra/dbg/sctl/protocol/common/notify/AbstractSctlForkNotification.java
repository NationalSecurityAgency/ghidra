...
public abstract class AbstractSctlForkNotification extends AbstractSctlForkCloneNotification
		implements HasOptionalProcessID {
	public AbstractSctlForkNotification() {
		super();
	}

	public AbstractSctlForkNotification(long spwnid, AbstractSctlContext ctx,
