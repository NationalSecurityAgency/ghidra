 ...
 */
public class Sctl2012LinuxProcessList extends AbstractSctlProcessList {
	@PacketField
	public long ntarg;
	...
	public List<Sctl2012LinuxProcessEntry> processes = new ArrayList<>();

	@Override
	public List<? extends AbstractSctlProcessEntry> getProcesses() {
		return processes;
	}

	@Override
	public Sctl2012LinuxProcessEntry addProcess() {
		Sctl2012LinuxProcessEntry proc = new Sctl2012LinuxProcessEntry();
		processes.add(proc);
		return proc;
	}
}
