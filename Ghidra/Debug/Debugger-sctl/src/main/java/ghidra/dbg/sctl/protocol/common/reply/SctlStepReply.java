...
/**
 * Format for the {@code Rstep} SCTL message
 */
public class SctlStepReply extends AbstractSctlReply {
	public SctlStepReply() {
	}

	public SctlStepReply(AbstractSctlContext ctx) {
		this.ctx = ctx;
	}
