...
/**
 * Format for the {@code Tenumtype} SCTL message
 */
public class SctlEnumerateTypesRequest extends AbstractSctlRequest {
	public SctlEnumerateTypesRequest() {
	}

	public SctlEnumerateTypesRequest(long nsid) {
		this.nsid = nsid;
	}
