...
/**
 * Format for the {@code Rattach} SCTL message
 */
public abstract class AbstractSctlAttachReply extends AbstractSctlReply
		implements HasOptionalPlatform {
	public AbstractSctlAttachReply() {
	}

	public AbstractSctlAttachReply(long ctlid, AbstractSctlContext ctx) {
		this.ctlid = ctlid;
		this.ctx = ctx;
	}
