...
public class SctlChooseContextRequest extends AbstractSctlRequest {
	public SctlChooseContextRequest() {
		super();
	}

	public SctlChooseContextRequest(long ctlid) {
		this.ctlid = ctlid;
	}
	...
	@CountedByField("nreg")
	@PacketField
	public List<Long> regids = new ArrayList<>();
}
