...
/**
 * The format for aggregate type definitions in SCTL
 */
public abstract class AbstractSctlAggregateTypeDefinition extends AbstractSctlTypeDefinition {
	@PacketField
	...
	@PacketField
	@RepeatedField
	@CountedByField("nfield")
	public List<SctlAggregateField> fields;
}
