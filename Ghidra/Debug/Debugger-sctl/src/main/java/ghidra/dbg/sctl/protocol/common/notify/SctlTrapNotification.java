...
/**
 * Format for the {@code Etrap} SCTL event
 */
public class SctlTrapNotification extends AbstractSctlEventNotification {
	public SctlTrapNotification() {
	}

	public SctlTrapNotification(long trpid, AbstractSctlContext ctx) {
		this.trpid = trpid;
		this.ctx = ctx;
	}
