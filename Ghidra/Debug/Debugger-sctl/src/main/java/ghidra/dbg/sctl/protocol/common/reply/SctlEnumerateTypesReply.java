...
import ghidra.dbg.sctl.protocol.types.SelSctlTypeDefinition;

/**
 * Format for the {@code Renumtype} SCTL message
 */
public class SctlEnumerateTypesReply extends AbstractSctlReply {
	@PacketField
	public long nt;
	...
	@RepeatedField
	@CountedByField("nt")
	public List<SelSctlTypeDefinition> tdefs;
}
