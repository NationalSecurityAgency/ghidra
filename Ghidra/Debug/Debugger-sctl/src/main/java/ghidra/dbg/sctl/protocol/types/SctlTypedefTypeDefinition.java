...
/**
 * The format for a {@code typedef} type definition in SCTL
 */
public class SctlTypedefTypeDefinition extends AbstractSctlTypeDefinition {
	@PacketField
	...
	public AbstractSctlTypeName getTypeName() {
		return new SctlTypedefTypeName(tid);
	}
}
