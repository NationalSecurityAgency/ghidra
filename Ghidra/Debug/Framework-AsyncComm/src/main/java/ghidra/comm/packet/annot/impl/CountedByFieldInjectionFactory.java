...
public class CountedByFieldInjectionFactory<ENCBUF, DECBUF>
	...
	public <T> FieldCodec<ENCBUF, DECBUF, T> getWrappedFieldCodecForType(
		...
		return new CountedByFieldInjectedFieldCodec<>(pktType, field, fldType, countedField, codec,
			chainNext);
	}
}
