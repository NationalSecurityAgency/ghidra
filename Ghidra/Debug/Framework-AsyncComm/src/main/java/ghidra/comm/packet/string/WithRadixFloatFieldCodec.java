...
/**
 * The {@link FieldCodec} for {@code float} fields annotated by {@link WithRadix}
 * 
 * @see WithRadixWrapperFactory
 */
public class WithRadixFloatFieldCodec extends AbstractFieldCodec<StringBuilder, CharBuffer, Float> {
	private final int radix;
	private final StringPacketCodec strCodec;
	private final FieldCodec<StringBuilder, CharBuffer, String> chainNext;

	public WithRadixFloatFieldCodec(Class<? extends Packet> pktType, Field field, int radix,
