...
/**
 * The factory injecting {@link TypedByFieldInjectedFieldCodec} on behalf of {@link TypedByField}
 *
 ...
 */
public class TypedByFieldInjectionFactory<ENCBUF, DECBUF, U>
	...
	public TypedByFieldInjectionFactory(Field typedField,
			BidiMap<Object, Class<? extends U>> typeMap) {
	...
	public <T> FieldCodec<ENCBUF, DECBUF, T> getWrappedFieldCodecForType(
		...
		return new TypedByFieldInjectedFieldCodec<>(pktType, field, fldType, typedField, typeMap,
			chainNext);
	}
}
